...
const App: React.FC = () => {
  ...
  const openWhatsApp = () => {
    window.open('https://wa.me/5511999999999?text=Olá! Gostaria de um orçamento para estética automotiva.', '_blank');
  };
    ...
    <div className="min-h-screen selection:bg-[#A855F7] selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-12">
            ...
            <button 
              ...
              className="px-8 py-3 rounded-none font-black text-[10px] uppercase tracking-[0.2em] btn-prism shadow-lg"
            >
              Agendar Avaliação
            </button>
          </div>
      ...
      <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-[#0A0A0A]">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 lg:gap-24 items-center relative z-10 w-full">
          {/* Main Text Content */}
          <div className="lg:col-span-7 z-50">
            <div className="inline-flex items-center gap-3 mb-8 bg-white/5 px-6 py-2 rounded-none border-l-2 border-[#A855F7] backdrop-blur-md">
              <Sparkles size={16} className="text-[#A855F7] fill-[#A855F7]" />
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl xl:text-[95px] font-heading font-black text-white leading-[0.85] uppercase italic tracking-tighter mb-10 relative">
              ...
              <span className="text-[#A855F7] relative z-50 block filter drop-shadow-[0_0_15px_rgba(168,85,247,0.4)]">De Elite</span>
              <span className="absolute -top-10 -left-10 text-[180px] text-outline opacity-5 font-black pointer-events-none hidden lg:block">GLOSS</span>
            </h1>

            <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
              <p className="text-base md:text-lg text-white/50 leading-relaxed font-medium">
                Seu carro merece o brilho de fábrica — ou melhor. Proteção cerâmica, PPF e detalhamento de precisão para quem não aceita menos que a perfeição.
              </p>
              <div className="flex flex-col gap-6">
                <button 
                  onClick={openWhatsApp}
                  className="bg-[#A855F7] text-white px-12 py-7 rounded-none font-black text-xs tracking-[0.3em] uppercase btn-prism shadow-2xl flex items-center justify-center gap-4"
                >
                ...
                <div className="flex items-center gap-8 px-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[9px] text-white/30 uppercase font-black tracking-widest mt-1">Garantia Shield</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative border border-white/10 bg-[#111111] p-3 transition-transform duration-700">
                ...
                <div className="absolute bottom-8 left-8">
                  <Droplets className="text-[#A855F7] mb-4" size={32} />
                  <p className="text-white font-heading text-base font-bold uppercase leading-none italic">Crystal <br />Protection</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="servicos" className="py-32 bg-[#0A0A0A] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col mb-24">
            ...
            <h2 className="text-5xl md:text-7xl font-heading font-black text-white italic uppercase leading-[0.9] tracking-tighter">Estética <br />Avançada.</h2>
          </div>
      ...
      <section id="processo" className="py-32 bg-[#050505] border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
             <span className="text-[#A855F7] text-[10px] font-black tracking-[0.5em] uppercase mb-4 block">Workflow</span>
             <h2 className="text-4xl font-heading font-black text-white italic uppercase">Protocolo de Restauração</h2>
          </div>
      ...
      <section id="faq" className="py-32 bg-[#050505]">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-3xl font-heading font-black text-white text-center uppercase italic mb-20">Dúvidas Comuns</h2>
      ...
      <section className="py-48 bg-[#0A0A0A] relative overflow-hidden text-center border-t border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-50">
          <h2 className="text-7xl md:text-9xl font-heading font-black text-white mb-16 leading-[0.8] uppercase italic tracking-tighter">Pure <br /> <span className="text-[#A855F7]">Reflex.</span></h2>
          <button 
            onClick={openWhatsApp}
            className="bg-[#A855F7] text-white px-16 py-8 rounded-none font-black text-sm tracking-[0.4em] uppercase btn-prism shadow-2xl"
          >
            Reservar Vaga Agora
          </button>
        </div>
      ...
      <footer className="bg-[#050505] pt-32 pb-16 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center border-t border-white/5 pt-12 gap-8 opacity-30">
            ...
            <p className="text-[8px] font-black uppercase tracking-[0.5em] text-white">© 2024 Carbon Detail Hub. Prism Div.</p>
            <div className="flex gap-8 text-[8px] font-black uppercase tracking-widest text-white italic">
              <span>9H Ceramic Coated</span>
              <span>Gloss Specialist</span>
            </div>
          </div>
        </div>
      </footer>
